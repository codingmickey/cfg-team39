...
const ShippingPage = ({ history }) => {
  ...
  return (
    <FormContainer>
      ...
      <h1 style={{ display: "none" }}>Shipping Address</h1>
      <Form onSubmit={handleSubmit}>
        <Form.Group controlId="address" style={{ display: "none" }}>
          <FloatingLabel
        ...
        <Form.Group controlId="city" style={{ display: "none" }}>
        ...
        <Form.Group controlId="postalCode" style={{ display: "none" }}>
          <FloatingLabel
        ...
        <Form.Group controlId="country" style={{ display: "none" }}>
          <FloatingLabel
